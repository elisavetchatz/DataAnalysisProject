...
% Without TMS
useTMS = 0;
[ci_without_TMS, bootstrap_means_without_TMS, p_values_without_TMS] = Group40Exe3Fun(data, num_resamples, useTMS);

% With TMS
useTMS = 1;
[ci_with_TMS, bootstrap_means_with_TMS, p_values_with_TMS] = Group40Exe3Fun(data, num_resamples, useTMS);
