...
chi_squared_resampled_one = Group40Exe2Fun(ED_coil_one, lambda1, num_resamples);
chi_squared_resampled_zero = Group40Exe2Fun(ED_coil_zero, lambda2, num_resamples);
